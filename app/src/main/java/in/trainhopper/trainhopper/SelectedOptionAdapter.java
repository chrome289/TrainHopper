...
class SelectedOptionAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        try {
            ...
            if (SelectedOption.element.legs.get(position) == null) {
                ...
                TextView textView = (TextView) convertView.findViewById(R.id.textView38);
                textView.setText(SelectedOption.element.layover / 3600 + ":" + (((SelectedOption.element.layover / 60 % 60) < 10) ? "0" : "") + SelectedOption.element.layover / 60 % 60 + " hrs");
            } else {
                ...
                textView.setText("Leg No. " + ((position / 2) + 1));

                textView = (TextView) convertView.findViewById(R.id.textView44);
                textView.setText("Duration : " + SelectedOption.element.legs.get(position).duration / 3600 + ":" + (((SelectedOption.element.legs.get(position).duration / 60 % 60) < 10) ? "0" : "") + SelectedOption.element.legs.get(position).duration / 60 % 60 + " hrs");
